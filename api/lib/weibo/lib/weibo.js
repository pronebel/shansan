...
Weibo.prototype.setToken=function(authData){
...
Weibo.prototype.getAuthorizeURL = function(url,$forcelogin, response_type, state, display) {
    state = state || '';
    $forcelogin= $forcelogin==undefined? true: false;
    display = display || '';
